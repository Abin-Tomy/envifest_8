...
const AboutSection = () => {
  ...
  const mediaItems = [
    { type: 'image', src: '/envipr1.webp', alt: 'Event 1' },
    { type: 'image', src: '/envipr2.webp', alt: 'Event 2' },
    { type: 'video', src: '/envi-abt7.4.mp4', alt: 'Event Video 1' },
    { type: 'image', src: '/envipr6.webp', alt: 'Event 5' },
    { type: 'image', src: '/envipr4.webp', alt: 'Event 4' },
    { type: 'video', src: '/envi-abt7.5.mp4', alt: 'Event Video 2' },
    { type: 'image', src: '/envipr3.webp', alt: 'Event 3' },
    { type: 'video', src: '/envi-abt7.6.mp4', alt: 'Event Video 3' },
    { type: 'video', src: '/envi-abt7.1.mp4', alt: 'Event 7' },
    { type: 'image', src: '/envipr2.webp', alt: 'Event 8' },
    { type: 'video', src: '/envi-abt7.3.mp4', alt: 'Event 6' },
    { type: 'image', src: '/envipr5.webp', alt: 'Event 9' },
    { type: 'image', src: '/envipr4.webp', alt: 'Event 10' },
    { type: 'video', src: '/envi-abt7.2.mp4', alt: 'Event 12' },
    { type: 'image', src: '/envipr5.webp', alt: 'Event 11' },
    { type: 'image', src: '/envipr1.webp', alt: 'Event 13' },
  ];
